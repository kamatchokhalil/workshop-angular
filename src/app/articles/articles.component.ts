...
nbrArticles: number;
nbrResService: number;
  constructor( private serviceCalcul: CalculServiceService) { }
  ...
  getDatawithService(){
    this.nbrResService = this.serviceCalcul.getNumberOf(this.listeArticles, 'categorie', 'Sport');
  }
}
